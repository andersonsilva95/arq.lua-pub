...
function Summon_Merry_Mother_TeleportFunc( iMonsterIndex, iFrame )
    ...
    if( iFrame <= 2 ) then
        ...
        if( 0 == CheckTeleport ) then
            ...
            local MotherPos = pMonster:GetMotherPos()
...
function Summon_Merry_Check_Walk( iMonsterIndex, iFrame )
	...
	if( pMonster:IsTarget() == true and pMonster:FloatRand() < 0.75 ) then
		if( pMonster:CheckTargetInRange( 0, -50, 50, 50, -50 ) == false and
		    pMonster:CheckTargetInRange( 0, -200, 100, 200, -100 ) == true ) then
			pMonster:TurnToTarget()
			pMonster:SetState( "WALK" )
			pMonster:ResetDelay()
		end
...
function Summon_Merry_Check_Stop( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 0, -50, 50, 50, -50 ) == true or
	    pMonster:CheckTargetInRange( 0, -600, 400, 600, -400 ) == false ) then
		pMonster:SetSpeedX( 0.0 )
		pMonster:SetState( "WAIT" )
		pMonster:ResetDelay()
	end
...
function Summon_Merry_Check_JumpUp( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 0, -100, 50, 100, -50 ) == false and
	    pMonster:CheckTargetInRange( 0, -600, 600, 600, -100 ) == true and
...
function OnSummon_Merry_Damage( iMonsterIndex )
	...
	if ( pMonster:FloatRand() < 0.1 and pMonster:CheckState( "STONECURSE" ) == false and pMonster:CheckState( "ICECURSE" ) == false and pMonster:CheckState( "HOLD" ) == false) then	
