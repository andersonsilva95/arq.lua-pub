...
function Initbossgate( iMonsterIndex )
	...
	pMonster:AddTraceParticleToBone( "Bossgate_01_h", 1.0, 0, 6, 6, 0.0, -0.05, true )
	pMonster:AddTraceParticleToBone( "Bossgate_02_h", 1.0, 0, 6, 6, 0.0, -0.05, true )
	pMonster:AddTraceParticleToBone( "Bossgate_Flame_01_h", 1.0, 0, 8, 8, 0.0, -0.05, true )
	pMonster:AddTraceParticleToBone( "Bossgate_Flame_02_h", 1.0, 0, 8, 8, 0.0, -0.05, true )
	pMonster:AddTraceParticleToBone( "Bossgate_Flame_04_h", 1.0, 0, 8, 8, 0.0, -0.05, true )
...
function bossgate_Damage0Func( iMonsterIndex, iFrame )
    ...
    if( pMonster:GetCountValue() == 0 and iFrame == 10 ) then
		local posx = 0.0
		local posy = -0.05
		pMonster:AddParticle("Bossgate_Spark_01_h" , posx, posy)
		pMonster:AddParticle("Bossgate_Spark_02_h" , posx, posy)
		pMonster:AddParticle("Bossgate_Spark_03" , posx, posy)
		pMonster:AddParticle("Bossgate_Spark_05_h" , posx, posy)
		...
		pMonster:AddTraceParticleToBone( "Bossgate_04_h", 1.0, 0, 6, 6, 0.0, posy, true )
...
function Onbossgate_Damage( iMonsterIndex )
	...
	pMonster:AddParticle("Bossgate_Hit_01_h" , posx, posy)
    ...
    if( pMonster:GetHP() / pMonster:GetMaxHP() <= 0.1 ) then
		pMonster:SetState("BOSSGATE_0")
		pMonster:SetInvincible( true )
    end
end