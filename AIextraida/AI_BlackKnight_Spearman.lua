...
{	
    ...
    {
        ID      = "ATTACK01",
        Motion  = "BlackKnight_Spearman_Attack01.frm",
...
function InitBlackKnight_Spearman( iMonsterIndex )
...
function BlackKnight_Spearman_Attack01Func( iMonsterIndex, iFrame )
    ...
    if( iFrame == 26 ) then
		pMonster:AddDamage(DT_BLACKKNIGHT_SPEARMAN_ATK1)
		pMonster:PlaySound(997011)
		local posX = 0.47
		local posY = 0.10
		if( pMonster:GetIsRight() ) then
			pMonster:AddParticle( "Spearmon_Slash_01", posX + 0.05, posY )
			pMonster:AddParticle( "Spearmon_Slash_02", posX + 0.05, posY )
		else
			pMonster:AddParticleNoDirection( "Spearmon_Slash_01_R", -posX, posY )
			pMonster:AddParticleNoDirection( "Spearmon_Slash_02_R", -posX, posY )
		end
    elseif( iFrame >= pMonster:GetLastFrame() ) then
        pMonster:SetState( "WAIT" )
    end
...
function BlackKnight_Spearman_Attack02Func( iMonsterIndex, iFrame )
	...
	elseif( iFrame == 50 ) then
		...
		local posY = 0.13
		if( pMonster:GetIsRight() ) then
			pMonster:AddParticle( "Spearmon_Dashslash_01", posX, posY )
			pMonster:AddParticle( "Spearmon_Dashslash_02", posX, posY )
			pMonster:AddParticle( "Spearmon_Dashslash_03", posX, posY )
		else
			pMonster:AddParticleNoDirection( "Spearmon_Dashslash_01_R", -posX, posY )
			pMonster:AddParticleNoDirection( "Spearmon_Dashslash_02_R", -posX, posY )
			pMonster:AddParticleNoDirection( "Spearmon_Dashslash_03_R", -posX, posY )
		end
	...
	elseif( iFrame == 91 ) then
		...
		local posY = 0.2
		if( pMonster:GetIsRight() ) then
			pMonster:AddParticle( "Spearmon_Dashslash_04", posX, posY )
			pMonster:AddParticle( "Spearmon_Dashslash_05", posX, posY )
			pMonster:AddParticle( "Spearmon_Dashslash_06", posX, posY )
		else
			pMonster:AddParticleNoDirection( "Spearmon_Dashslash_04_R", -posX, posY )
			pMonster:AddParticleNoDirection( "Spearmon_Dashslash_05_R", -posX, posY )
			pMonster:AddParticleNoDirection( "Spearmon_Dashslash_06_R", -posX, posY )
		end
    elseif( iFrame >= pMonster:GetLastFrame() ) then
        pMonster:SetState( "WAIT" )
    end
