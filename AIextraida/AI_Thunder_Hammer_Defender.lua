...
{	
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 30,
                AIFunc              = "Thunder_Hammer_Defender_Check_Targeting",
                DelayFrame          = 40,
            },
            ...
            {
                AICheckFrame        = 330,
                AIFunc              = "Thunder_Hammer_Defender_Check_ReleaseTarget",
                DelayFrame          = 330,
            },
            ...
            {
                AICheckFrame        = 25,
                AIFunc              = "Thunder_Hammer_Defender_Check_TurnToTarget",
                DelayFrame          = 30,
            },
            ...
            {
                AICheckFrame        = 30,
                AIFunc              = "Thunder_Hammer_Defender_Check_Walk",
                DelayFrame          = 150,
				DelayFrame1         = 100,
				DelayFrame2         = 20,
				DelayFrame3         = 20,
            ...
            {
                AICheckFrame        = 41,
                AIFunc              = "Thunder_Hammer_Defender_Check_JumpUp",
                DelayFrame          = 50,
            },        
            ...
            {
                AICheckFrame        = 42,
                AIFunc              = "Thunder_Hammer_Defender_Check_JumpDown",
                DelayFrame          = 30,
            },
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "Thunder_Hammer_Defender_Check_Attack01",
                DelayFrame          = 110,
            },
            ...
            {
                AICheckFrame        = 25,
                AIFunc              = "Thunder_Hammer_Defender_Check_Attack02",
                DelayFrame          = 440,
				DelayFrame1         = 330,
				DelayFrame2         = 220,
				DelayFrame3         = 220,
            ...
            {
                AICheckFrame        = 33,
                AIFunc              = "Thunder_Hammer_Defender_Check_Attack03",
                DelayFrame          = 666,
				DelayFrame1         = 555,
				DelayFrame2         = 333,
				DelayFrame3         = 333,
    ...
    -- 이동
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 5,
                AIFunc              = "Thunder_Hammer_Defender_Check_Stop",
                DelayFrame          = 55,
            },
        }
    },
    ...
    -- 다운 중 
    {
        ...
        Trigger =
        {
            {
                AICheckFrame        = 5,
                AIFunc              = "Thunder_Hammer_Defender_CheckStandup",
                DelayFrame          = 0,
            },
        }
		--]]
...
function Thunder_Hammer_Defender_Attack01Func( iMonsterIndex, iFrame )
	...
	elseif( iFrame == 56 ) then
		...
		if( pMonster:GetIsRight() == false ) then
			...
			pMonster:AddParticleNoDirection("THDefender_Scratch_R", posx, posy)
		else
			pMonster:AddParticleNoDirection("THDefender_Slash", posx, posy)
			pMonster:AddParticleNoDirection("THDefender_Scratch", posx, posy)
		end
    elseif( iFrame >= pMonster:GetLastFrame() ) then
        pMonster:SetState( "WAIT" )
    end
...
function Thunder_Hammer_Defender_Check_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )

    if( pMonster:SetTarget( 100, -300, 360, 300, -300 ) == true ) then
...
function Thunder_Hammer_Defender_Check_ReleaseTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function Thunder_Hammer_Defender_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function Thunder_Hammer_Defender_Check_Walk( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )

	if( pMonster:IsTarget() == true ) then
		if( pMonster:CheckTargetInRange( 0, -220, 600, 220, -600 ) == false and pMonster:FloatRand() < 0.8 ) then
			pMonster:TurnToTarget()
			pMonster:SetState( "WALK" )
			pMonster:ResetDelay()
		end
...
function Thunder_Hammer_Defender_Check_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Thunder_Hammer_Defender_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Thunder_Hammer_Defender_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Thunder_Hammer_Defender_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Thunder_Hammer_Defender_Check_JumpUp( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Thunder_Hammer_Defender_Check_JumpDown( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Thunder_Hammer_Defender_CheckStandup( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
