...
{	
    ...
    {
        ID      = "DAMAGE_MIDDLE",
        Motion  = "Decoy_Damage_Middle.frm",
        Func    = "Decoy_DamageFunc",
    },
...
function Decoy_Attack01Func( iMonsterIndex, iFrame )
    ...
    if( iFrame == 32 ) then
		pMonster:AddDamage(DT_DECOY_TONGUE_ATK)
...
function Decoy_Attack02Func( iMonsterIndex, iFrame )
	...
	elseif( iFrame == 44 ) then
		...
		pMonster:StartAttack( 9, PAR_DOWN, 0.3, 0, 0, 10)
...
function Decoy_Check_Targeting( iMonsterIndex, iFrame )
    ...
    if( pMonster:SetTarget( 100, -350, 200, 350, -250 ) == true ) then
...
function Decoy_Check_Walk( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 500, -200, 200, 200, -100 ) == true and pMonster:FloatRand() < 0.7) then
			pMonster:TurnToTarget()
			pMonster:SetState( "WALK" )
			pMonster:ResetDelay()
	end
...
function Decoy_Check_Stop( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 250, -200, 150, 200, -100 ) == true ) then
...
function Decoy_Check_Attack01( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 200, -150, 60, 150, -100 ) == true ) then
...
function Decoy_Check_JumpUp( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 100, -100, 320, 100, 80 ) == true and pMonster:GetIsContact() == true and pMonster:GetTargetIsContact() == true ) then
...
function OnDecoy_Damage( iMonsterIndex )
	...
	if( pMonster:CheckState( "DOWN_UP01" ) == false and pMonster:CheckState( "DOWN_UP02" ) == false and pMonster:CheckState( "DOWN_MIDDLE" ) == false and pMonster:CheckState( "DOWN_DOWN" ) == false and pMonster:CheckState( "DOWN_SPECIAL" ) == false) then
		if( pMonster:FloatRand() < 0.05 and pMonster:GetIsContact() == true and pMonster:IsSuperArmor() == false and pMonster:GetIsRight() ~= pMonster:GetTargetIsRight() ) then
			pMonster:TurnToTarget()
			pMonster:SetState( "ATTACK02" )
		end
	end
