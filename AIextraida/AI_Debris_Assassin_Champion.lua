-- AI_Debris_Assassin_Champion.lua
...
{	
    -- 대기
    {
        ...
        Func    = "AssassinChampion_WaitFunc",
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "AssassinChampion_Check_Targeting",
                DelayFrame          = 200,
            },
            ...
            --{
            --    AICheckFrame        = 300,
            --    AIFunc              = "AssassinChampion_Check_ReleaseTarget",
            --    DelayFrame          = 200,
            --},
            ...
            {
                AICheckFrame        = 15,
                AIFunc              = "AssassinChampion_Check_TurnToTarget",
                DelayFrame          = 10,
            },
            ...
            {
                AICheckFrame        = 110,
                AIFunc              = "AssassinChampion_Check_Run",
                DelayFrame          = 110,
            },
            ...
            {
                AICheckFrame        = 102,
                AIFunc              = "AssassinChampion_Check_JumpUp",
                DelayFrame          = 220,
            },        
            ...
            {
                AICheckFrame        = 51,
                AIFunc              = "AssassinChampion_Check_JumpDown",
                DelayFrame          = 110,
            },
            ...
            {
                AICheckFrame        = 110,
                AIFunc              = "AssassinChampion_Check_Attack01",
                DelayFrame          = 220,
            },
            ...
            {
                AICheckFrame        = 330,
                AIFunc              = "AssassinChampion_Check_Attack02",
                DelayFrame          = 440,
            },
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "AssassinChampion_Check_Attack03",
                DelayFrame          = 190,
            },
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "AssassinChampion_Check_Attack04",
                DelayFrame          = 190,
            },
            ...
            {
                AICheckFrame        = 100,
                AIFunc              = "AssassinChampion_Check_Attack05",
                DelayFrame          = 100,
            },
            ...
            --{
            --    AICheckFrame        = 550,
            --    AIFunc              = "AssassinChampion_Check_Attack06",
            --    DelayFrame          = 1100,
            --},
    ...
    -- 이동
    {
        ...
        Func            = "AssassinChampion_runFunc",
        EnableMoveCheck = TRUE,
        MoveFailFunc    = "AssassinChampion_MoveFail",
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 5,
                AIFunc              = "AssassinChampion_Check_Stop",
                DelayFrame          = 25,
            },
        }
    },
    ...
    -- 다크볼 
    {
        ...
        Func    = "AssassinChampion_Attack01Func",
    },
    ...
    -- 베큠 필라
    {
        ...
        Func    = "AssassinChampion_Attack02Func",
    },
	...
	-- 파이브 스타 ( 상단 )
    {
        ...
        Func    = "AssassinChampion_Attack03Func",
    },
    ...
    -- 파이브 스타 ( 하단 )
    {
        ...
        Func    = "AssassinChampion_Attack04Func",
    },
	...
	-- 
    {
        ...
        Func    = "AssassinChampion_Attack05_1Func",
    },
	...
	-- 
    {
        ...
        Func    = "AssassinChampion_Attack05_2Func",
    },
	...
	-- 
    {
        ...
        Func    = "AssassinChampion_Attack06_Func",
    },
	...
	-- 
    {
        ...
        Func    = "AssassinChampion_Attack06_2Func",
    },
    ...
    -- 점프
    {
        ...
        Func    = "AssassinChampion_JumpFunc",
    },
    ...
    -- 점프
    {
        ...
        Func    = "AssassinChampion_JumpDownFunc",
    },
    ...
    -- 데미지 중
    {
        ...
        Func    = "AssassinChampion_DamageFunc",
    },

    -- 죽기 착지
    {
        ID      = "DIE_LANDING",
        Motion  = "vairne_middle_die.frm",
        Func    = "AssassinChampion_DieLandingFunc",
...
CallBack =
{
    Land    = "OnAssassinChampion_Land",
    Die     = "OnAssassinChampion_Die",
    Damage  = "OnAssassinChampion_Damage",
}
...
function InitAssassinChampion( iMonsterIndex )
...
-- 대기 상태
function AssassinChampion_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 걷기 상태
function AssassinChampion_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
-- 걷기 상태
function AssassinChampion_runFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
-- 죽기 착지
function AssassinChampion_DieLandingFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    ...
    elseif( iFrame == 3 ) then 
        for i = 0, 15 do 
            local pGate = g_MyD3D:GetMonster( i )
            if( pGate:GetMonsterType() == 313 or pGate:GetMonsterType() == 314 ) then 
                pGate:ClearMagicEffect( i, EGC_EFFECT_MON_INFINITY_DEFENCE )
            end
        end
...
-- 데미지 입은거
function AssassinChampion_DamageFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  근접공격 상태
function AssassinChampion_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
	if( iFrame <= 1 ) then
...
--  점프 상태
function AssassinChampion_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  
function AssassinChampion_Attack03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  
function AssassinChampion_Attack04Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  
function AssassinChampion_Attack05_1Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Attack05_2Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Attack06_Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Attack06_2Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function AssassinChampion_JumpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 다운 상태
function AssassinChampion_JumpDownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function AssassinChampion_ToWait( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Check_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Check_ReleaseTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Check_Run( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )

	if( pMonster:IsTarget() == true ) then
		if( pMonster:CheckTargetInRange( 0, -300, 1600, 300, -1600 ) == false and pMonster:FloatRand() < 0.5 ) then
			pMonster:TurnToTarget()
			pMonster:SetState( "RUN" )
			pMonster:ResetDelay()
		end
...
function AssassinChampion_Check_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    

	if( pMonster:CheckTargetInRange( 0, -300, 1600, 300, -1600 ) == true ) then
		pMonster:SetSpeedX( 0.0 )
		pMonster:SetState( "WAIT" )
		pMonster:ResetDelay()
	end
...
function AssassinChampion_CheckDownUp02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function AssassinChampion_Check_Attack04( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function AssassinChampion_Check_Attack05( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function AssassinChampion_Check_Attack06( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function AssassinChampion_Check_JumpUp( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
	...
	if( pMonster:CheckTargetInRange( 150, -150, 1200, 150, 80 ) == true and pMonster:GetIsContact() == true and pMonster:GetTargetIsContact() == true ) then
		AssassinChampion_Jump( iMonsterIndex )
		pMonster:SetState( "JUMP" )
		pMonster:ResetDelay()
	end
end

function AssassinChampion_Check_JumpDown( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnAssassinChampion_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnAssassinChampion_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnAssassinChampion_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_Jump( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function AssassinChampion_MoveFail( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
