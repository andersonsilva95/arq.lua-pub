...
ActionList =
{
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 55,
                AIFunc              = "FireGolem_trans_Check_Targeting",
                DelayFrame          = 330,
            },
            -- 타겟을 향해 턴
            {
                AICheckFrame        = 75,
                AIFunc              = "FireGolem_trans_Check_TurnToTarget",
                DelayFrame          = 75,
            },
            ...
            {
                AICheckFrame        = 75,
                AIFunc              = "FireGolem_trans_Check_Walk",
                DelayFrame          = 110,
            },
            -- 근접공격
            {
                AICheckFrame        = 55,
                AIFunc              = "FireGolem_trans_Check_Attack01",
                DelayFrame          = 110,
            },
            -- 파이어브레스
            {
                AICheckFrame        = 75,
                AIFunc              = "FireGolem_trans_Check_Attack02",
                DelayFrame          = 110,
            },
            -- 지진공격
            {
                AICheckFrame        = 330,
                AIFunc              = "FireGolem_trans_Check_Attack03",
                DelayFrame          = 750,
				DelayFrame1         = 660,
				DelayFrame2         = 430,
            },
            ...
            {
                AICheckFrame        = 145,
                AIFunc              = "FireGolem_trans_Check_Attack04",
                DelayFrame          = 110,
            },
            ...
            {
                AICheckFrame        = 35,
                AIFunc              = "FireGolem_trans_Check_HighJump",
                DelayFrame          = 40,
            },        
            -- 점프다운
            {
                AICheckFrame        = 35,
                AIFunc              = "FireGolem_trans_Check_JumpDown",
                DelayFrame          = 40,
            },
    ...
    -- 이동
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 10,
                AIFunc              = "FireGolem_trans_Check_Stop",
                DelayFrame          = 55,
            },
    ...
    -- 근접공격01
    {
        ...
        Func    = "FireGolem_trans_Attack01Func",
    },
    ...
    -- 파이어브레스
    {
        ...
        Func    = "FireGolem_trans_Attack02Func",
    },
    ...
    -- 지진공격
    {
        ...
        Func    = "FireGolem_trans_Attack03Func",
    },
    ...
    -- 분노의 불기둥_소리지르기
    {
        ...
        Func    = "MiniFireGolem_trans_Attack04Func",
    },
    ...
    -- 점프
    {
        ...
        Func    = "FireGolem_trans_JumpDownFunc",
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 50,
                AIFunc              = "FireGolem_trans_Check_Landing",
                DelayFrame          = 1,
            },
        },
    },
    ...
    -- 점프
    {
        ...
        Func    = "FireGolem_trans_ToWait",
    },
}

CallBack =
{
    Land    = "OnFireGolem_trans_Land",
    Die     = "OnFireGolem_trans_Die",
    Damage  = "OnFireGolem_trans_Damage",
}
...
function Inithell_guard_soldier_trans( iMonsterIndex )
...
-- 대기 상태
function FireGolem_trans_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 걷기 상태
function FireGolem_trans_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 죽는상태
function FireGolem_trans_DieFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 죽는상태
function FireGolem_trans_Die1Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 데미지 입은거
function FireGolem_trans_DamageFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  근접공격 상태
function FireGolem_trans_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  파이어브레스 상태
function FireGolem_trans_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  지진공격 상태
function FireGolem_trans_Attack03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  파이어브레스흉내내기 상태
function MiniFireGolem_trans_Attack04Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function FireGolem_trans_JumpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 다운 상태
function FireGolem_trans_JumpDownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function FireGolem_trans_ToWait( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function FireGolem_trans_Check_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function FireGolem_trans_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function FireGolem_trans_Check_Walk( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function FireGolem_trans_Check_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function FireGolem_trans_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function FireGolem_trans_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function FireGolem_trans_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function FireGolem_trans_Check_Attack04( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function FireGolem_trans_Check_HighJump( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
    ...
    if( pMonster:CheckTargetInRange( 100, -600, 500, 600, 100 ) == true and pMonster:GetIsContact() == true and pMonster:GetTargetIsContact() == true ) then
		FireGolem_trans_Jump( iMonsterIndex )
		pMonster:SetState( "JUMP" )
		pMonster:ResetDelay()
    end
end

function FireGolem_trans_Check_JumpDown( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function FireGolem_trans_Check_Landing( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnFireGolem_trans_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnFireGolem_trans_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnFireGolem_trans_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function FireGolem_trans_Jump( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
