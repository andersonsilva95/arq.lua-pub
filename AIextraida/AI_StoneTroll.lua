...
ActionList =
{
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 25,
                AIFunc              = "StoneTroll_Check_Targeting",
                DelayFrame          = 110,
            },
            -- 타겟지움
            {
                AICheckFrame        = 220,
                AIFunc              = "StoneTroll_Check_ReleaseTarget",
                DelayFrame          = 440,
            },
            -- 타겟을 향하여 돌기
            {
                AICheckFrame        = 25,
                AIFunc              = "StoneTroll_Check_TurnToTarget",
                DelayFrame          = 0,
            },
            ...
            {
                AICheckFrame        = 55,
                AIFunc              = "StoneTroll_Check_Attack01",
                DelayFrame          = 150,
            },
            ...
            {
                AICheckFrame        = 110,
                AIFunc              = "StoneTroll_Check_Attack02",
                DelayFrame          = 220,
            },
            ...
            {
                AICheckFrame        = 150,
                AIFunc              = "StoneTroll_Check_JumpAttack",
                DelayFrame          = 300,
            },
    ...
    -- 점프 착지할때..
    {
        ...
        Func    = "StoneTroll_JumpLandingFunc",
    },
    ...
    -- 점프공격
    {
        ...
        Func    = "StoneTroll_JumpAttackFunc",

        Trigger =
        {
            {
                AICheckFrame        = 1,
                AIFunc              = "StoneTroll_Process_Jump",
                DelayFrame          = 0,
            },
        }
    },
    ...
    -- 점프공격 착지할때..
    {
        ...
        Func    = "StoneTroll_JumpAttackLandingFunc",
    },
    ...
    -- 다운 상01
    {
        ...
        Func    = "StoneTroll_DownUp01Func",
        
        Trigger =
        {
            {
                AICheckFrame        = 1,
                AIFunc              = "StoneTroll_CheckDownUp02",
                DelayFrame          = 0,
            },
        }
    },
    ...
    -- 다운 상 착지
    {
        ...
        Trigger =
        {
            {
                AICheckFrame        = 5,
                AIFunc              = "StoneTroll_CheckStandup",
                DelayFrame          = 0,
            },
        }
    },
    ...
    -- 스톤커스
    {
        ...
        Func    = "StoneTroll_StoneCurseFunc",
    },
    ...
    -- 홀드상태
    {
        ID      = "HOLD",
        Motion  = "Troll_Stone.frm",
        Func    = "StoneTroll_HoldFunc",
    },
}

CallBack =
{
    Land    = "OnStoneTroll_Land",
    Die     = "OnStoneTroll_Die",
    Damage  = "OnStoneTroll_Damage",
}
...
function InitStoneTroll( iMonsterIndex )
...
-- 대기 상태
function StoneTroll_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 걷기 상태
function StoneTroll_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 점프 상태
function StoneTroll_JumpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 점프착지
function StoneTroll_JumpLandingFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 점프 상태
function StoneTroll_JumpAttackFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 착지하면서 지진
function StoneTroll_JumpAttackLandingFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 삼단치기 상태
function StoneTroll_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
	...
	elseif( iFrame == 96 ) then
		pMonster:EarthQuakeWithRange( 25, 0.06, 0.03, 1.0 )
...
-- 돌진공격 상태
function StoneTroll_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 죽었음
function StoneTroll_DieFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 데미지 입은거
function StoneTroll_DamageFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 상
function StoneTroll_DownUp01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 상2
function StoneTroll_DownUp02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 상3
function StoneTroll_DownUp03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 일어나기
function StoneTroll_StandUpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  스톤커스 걸렸음
function StoneTroll_StoneCurseFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  아이스커스 걸렸음
function StoneTroll_IceCurseFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  홀드 걸렸음(이펙트)
function StoneTroll_HoldFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 컨디션체크
-----------------------------------------------------------------------
function StoneTroll_Check_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function StoneTroll_Check_ReleaseTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function StoneTroll_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function StoneTroll_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function StoneTroll_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    

    if( pMonster:CheckTargetInRange( 350, -200, 150, 200, -100 ) == true ) then
		pMonster:AddCountValue(1)
...
function StoneTroll_Check_JumpAttack( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function StoneTroll_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function StoneTroll_Check_FireBreath( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function StoneTroll_Check_Attack04( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function StoneTroll_CheckDownUp02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function StoneTroll_Process_Jump( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    --pMonster:SetPushCheck( false )
...
function StoneTroll_CheckStandup( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnStoneTroll_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnStoneTroll_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnStoneTroll_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
