...
{	
    ...
    {
        ID      = "WAIT",
        Motion  = "Astarot_Phase03_f_Wait.frm",
        Func    = "CownatAstarotPhase3_WaitFunc",
    ...
    {
        ID      = "ATTACK01",
        Motion  = "Astarot_Phase03_f_Attack01_B.frm",
        Func    = "CownatAstarotPhase3_Attack01_B_Pattern1Func",
    },
    -- 점프
    {
        ID      = "JUMP",
...
-- 대기 상태
function CownatAstarotPhase3_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  근접공격 상태
function CownatAstarotPhase3_Attack01_B_Pattern1Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
	if( iFrame >= pMonster:GetLastFrame() ) then
        pMonster:SetState( "WAIT" )
    end
