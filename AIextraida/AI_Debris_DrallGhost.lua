...
{	
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 55,
                AIFunc              = "DrallGhost_Targeting",
                DelayFrame          = 200,
            },
            -- 타겟지움
            --{
            --    AICheckFrame        = 550,
            --    AIFunc              = "DrallGhost_Check_ReleaseTarget",
            --    DelayFrame          = 330,
            --},
            -- 타겟을 향해 턴
            {
                AICheckFrame        = 20,
                AIFunc              = "DrallGhost_Check_TurnToTarget",
                DelayFrame          = 20,
            },
            ...
            {
                AICheckFrame        = 91,
                AIFunc              = "DrallGhost_Check_JumpUp",
                DelayFrame          = 100,
            },
            ...
            {
                AICheckFrame        = 61,
                AIFunc              = "DrallGhost_Check_JumpDown",
                DelayFrame          = 80,
            },
            ...
            {
                AICheckFrame        = 10,
                AIFunc              = "DrallGhost_Check_Attack01",
                DelayFrame          = 90,
            },
            ...
            {
                AICheckFrame        = 110,
                AIFunc              = "DrallGhost_Check_Attack01_2",
                DelayFrame          = 330,
            },
            ...
            {
                AICheckFrame        = 220,
                AIFunc              = "DrallGhost_Check_Attack02",
                DelayFrame          = 220,
            },
            ...
            {
                AICheckFrame        = 55,
                AIFunc              = "DrallGhost_Check_Attack03",
                DelayFrame          = 550,
            },
            ...
            {
                AICheckFrame        = 200,
                AIFunc              = "DrallGhost_Check_Attack04",
                DelayFrame          = 400,
            },
            ...
            --{
            --    AICheckFrame        = 250,
            --    AIFunc              = "DrallGhost_Check_Attack06",
            --    DelayFrame          = 330,
            --},
        },
    },
    ...
    -- 이동
    {
        ...
        Func            = "DrallGhost_WalkFunc",
        EnableMoveCheck = TRUE,
        MoveFailFunc    = "DrallGhost_MoveFail",
    ...
    -- 데몬 파이어 A
    {
        ...
        Func    = "DrallGhost_Attack06_AFunc",
    },
    ...
    -- 데몬 파이어 B
    {
        ...
        Func    = "DrallGhost_Attack06_BFunc",
    },
    ...
    -- 죽기 착지
    {
        ...
        Func    = "DrallGhost_DieLandingFunc",
...
CallBack =
{
    Land    = "OnDrallGhost_Land",
    Die     = "OnDrallGhost_Die",
    Damage  = "OnDrallGhost_Damage",
}
...
function InitDrallGhost( iMonsterIndex )
...
-- 대기 상태
function DrallGhost_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 걷기 상태
function DrallGhost_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 죽기 착지
function DrallGhost_DieLandingFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  패러독스 스윙
function DrallGhost_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  3단 부스트 
function DrallGhost_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 윈드밀 대쉬 
function DrallGhost_Attack03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  스톰프
function DrallGhost_Attack04Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  더블 스톰프
function DrallGhost_Attack05Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  데몬 파이어 A
function DrallGhost_Attack06_AFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  데몬 파이어 B
function DrallGhost_Attack06_BFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    local iDir = 1
...
--  점프 상태
function DrallGhost_JumpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 다운 상태
function DrallGhost_JumpDownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function DrallGhost_ToWait( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_Check_ReleaseTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_Check_Walk( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_Check_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function DrallGhost_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function DrallGhost_Check_Attack01_2( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function DrallGhost_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function DrallGhost_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function DrallGhost_Check_Attack04( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_Check_Attack06( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function DrallGhost_Check_JumpUp( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function DrallGhost_Check_JumpDown( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnDrallGhost_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnDrallGhost_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnDrallGhost_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_Jump( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function DrallGhost_MoveFail( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
