...
--]]
    ...
    {
        ID      = "ATTACK02",
        Motion  = "Green_Slime_Attack02.frm",
        Func    = "Slime_Attack02Func",
    },
...
function Slime_DieLandingFunc( iMonsterIndex, iFrame )
	...
	elseif( iFrame == 12 ) then
		pMonster:PlaySound(988005)
	elseif( iFrame == 68 ) then
		pMonster:AddDamage(DT_GREEN_SLIME_BOMB)
	elseif( iFrame >= pMonster:GetLastFrame() ) then
        pMonster:EndMonster()
...
function Slime_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Slime_Check_JumpUp( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 150, -150, 360, 150, 80 ) == true and pMonster:GetIsContact() == true and pMonster:GetTargetIsContact() == true ) then
...
function Slime_Check_JumpDown( iMonsterIndex, iFrame )
	...
	if( pMonster:CheckTargetInRange( 100, -120, -100, 120, -400 ) == true ) then
