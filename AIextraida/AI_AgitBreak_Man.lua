...
ActionList =
{
    ...
    {
        ID      = "WAIT",
        Motion  = "break_man_wait.frm",
        Func    = "AgitBreak_Man_WaitFunc",
    },

    -- 송판 5개 이하모션 처리
    {
        ID      = "BREAK_5",
        Motion  = "break_man_A.frm",
        Func    = "AgitBreak_Man_5", 
    },

    -- 송판 10개 이하모션 처리
    {
        ID      = "BREAK_10",
        Motion  = "break_man_B.frm",
        Func    = "AgitBreak_Man_10", 
    },
}
...
function InitAgitBreak_Man( iMonsterIndex )
...
-- 대기 상태
function AgitBreak_Man_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    local MotherUID = pMonster:GetSummonPlayerUID()
    local pPlayer = g_MyD3D:GetPlayerByUID( MotherUID )
...
-- 송판 5장 이하
function AgitBreak_Man_5( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    local MotherUID = pMonster:GetSummonPlayerUID()
    local pPlayer = g_MyD3D:GetPlayerByUID( MotherUID )
...
-- 송판 10장 이하
function AgitBreak_Man_10( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    local MotherUID = pMonster:GetSummonPlayerUID()
    local pPlayer = g_MyD3D:GetPlayerByUID( MotherUID )
