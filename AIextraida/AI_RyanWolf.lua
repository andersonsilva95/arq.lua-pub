...
ActionList =
{
    ...
    -- 빙결상태
    {
        ID      = "ICECURSE",
        Motion  = "059.frm",
        Func    = "RyanWolf_IceCurseFunc",
    },
}

CallBack =
{
    Land    = "OnRyanWolf_Land",
    Die     = "OnRyanWolf_Die",
    Damage  = "OnRyanWolf_Damage",
}
...
function InitRyanWolf( iMonsterIndex )
...
-- 대기 상태
function RyanWolf_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    pMonster:SetInvincible( true )
...
-- 걷기 상태
function RyanWolf_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    pMonster:SetInvincible( true )
...
-- 필살기 1
function RyanWolf_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    pMonster:SetInvincible( true )
    if( iFrame == 12 ) then
...
function RyanWolf_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    pMonster:SetInvincible( true )
	if( iFrame == 9 ) then 
...
-- 죽었음
function RyanWolf_DieFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    if( iFrame <= 1) then
		pMonster:SetInvincible( true )
...
-- 일어나기
function RyanWolf_StandupFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  스톤커스 걸렸음
function RyanWolf_StoneCurseFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  아이스커스 걸렸음
function RyanWolf_IceCurseFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnRyanWolf_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnRyanWolf_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnRyanWolf_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnRyanWolf_Jump( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
