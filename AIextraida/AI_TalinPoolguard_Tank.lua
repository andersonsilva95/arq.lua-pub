...
{	
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "Talin_Pollguard_Check_Targeting",
                DelayFrame          = 60,
            },
            ...
            {
                AICheckFrame        = 300,
                AIFunc              = "Talin_Pollguard_Check_ReleaseTarget",
                DelayFrame          = 100,
            },
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "Talin_Pollguard_Check_TurnToTarget",
                DelayFrame          = 10,
            },
            ...
            {
                AICheckFrame        = 44,
                AIFunc              = "Talin_Pollguard_Check_Attack01",
                DelayFrame          = 129,
            },
            ...
            {
                AICheckFrame        = 110,
                AIFunc              = "Talin_Pollguard_Check_Attack02",
                DelayFrame          = 80,
            },
            ...
            {
                AICheckFrame        = 222,
                AIFunc              = "Talin_Pollguard_Check_Attack03",
                DelayFrame          = 55,
            },
            ...
            {
                AICheckFrame        = 111,
                AIFunc              = "Talin_Pollguard_Check_Attack04",
                DelayFrame          = 11,
            },
            ...
            {
                AICheckFrame        = 70,
                AIFunc              = "Talin_Pollguard_Check_Attack05",
                DelayFrame          = 193,
            },
            ...
            {
                AICheckFrame        = 84,
                AIFunc              = "Talin_Pollguard_Check_Attack06",
                DelayFrame          = 123,
            },
            ...
            --{
            --	AICheckFrame        = 10,
            --	AIFunc              = "Talin_Pollguard_Check_Attack06_2",
            --	DelayFrame          = 100,
            --},
        },
    },
    ...
    {
        ID              = "WALK",
        Motion          = "Talin_Pollguard_move.frm",
        Func            = "Talin_Pollguard_moveFunc",
        EnableMoveCheck = TRUE,
        MoveFailFunc    = "Talin_Pollguard_MoveFail",
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 10,
                AIFunc              = "Talin_Pollguard_Check_Stop",
                DelayFrame          = 55,
            },
			-- 크루얼 크러쉬 [50%]
            {
...
function Talin_Pollguard_moveFunc( iMonsterIndex, iFrame )
	...
	if( iFrame == 6 or iFrame == 63 ) then
		pMonster:PlaySound(992022)
...
function Talin_Pollguard_Check_Walk( iMonsterIndex, iFrame )
	...
	if( pMonster:IsTarget() == true ) then
		if( pMonster:CheckTargetInRange( 0, -700, 800, 700, -100 ) == false and pMonster:FloatRand() < 0.5 ) then
			pMonster:TurnToTarget()
			pMonster:SetState( "WALK" )
			pMon:SetState( "WALK" )
			pMonster:ResetDelay()
...
function OnTalin_Pollguard_Damage( iMonsterIndex )
	...
	if( pMonster:IsSuperArmor() == false and pMonster:CheckState( "STONECURSE" ) == false and pMonster:CheckState( "ICECURSE" ) == false  and pMonster:CheckState( "HOLD" ) == false ) then
		if( pMonster:CheckTargetInRange( 0, -360, 800, 360, -100 ) == true ) then
		...
		elseif( pMonster:CheckTargetInRange( 1300, -400, 800, 400, -100 ) == true ) then
