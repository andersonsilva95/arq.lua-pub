...
{	
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "VairneGhost_Check_Targeting",
                DelayFrame          = 200,
            },
            ...
            --{
            --    AICheckFrame        = 300,
            --    AIFunc              = "VairneGhost_Check_ReleaseTarget",
            --    DelayFrame          = 200,
            --},
            ...
            {
                AICheckFrame        = 15,
                AIFunc              = "VairneGhost_Check_TurnToTarget",
                DelayFrame          = 10,
            },
            ...
            {
                AICheckFrame        = 102,
                AIFunc              = "VairneGhost_Check_JumpUp",
                DelayFrame          = 220,
            },        
            ...
            {
                AICheckFrame        = 51,
                AIFunc              = "VairneGhost_Check_JumpDown",
                DelayFrame          = 110,
            },
            ...
            {
                AICheckFrame        = 110,
                AIFunc              = "VairneGhost_Check_Attack01",
                DelayFrame          = 220,
            },
            ...
            {
                AICheckFrame        = 330,
                AIFunc              = "VairneGhost_Check_Attack02",
                DelayFrame          = 440,
            },
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "VairneGhost_Check_Attack03",
                DelayFrame          = 190,
            },
            ...
            {
                AICheckFrame        = 20,
                AIFunc              = "VairneGhost_Check_Attack04",
                DelayFrame          = 190,
            },
            ...
            {
                AICheckFrame        = 100,
                AIFunc              = "VairneGhost_Check_Attack05",
                DelayFrame          = 100,
            },
            ...
            --{
            --    AICheckFrame        = 550,
            --    AIFunc              = "VairneGhost_Check_Attack06",
            --    DelayFrame          = 1100,
            --},
    ...
    -- 이동
    {
        ...
        Func            = "VairneGhost_runFunc",
        EnableMoveCheck = TRUE,
        MoveFailFunc    = "VairneGhost_MoveFail",
	...
	-- 
    {
        ...
        Func    = "VairneGhost_Attack05_1Func",
    },
	...
	-- 
    {
        ...
        Func    = "VairneGhost_Attack05_2Func",
    },
	...
	-- 
    {
        ...
        Func    = "VairneGhost_Attack06_Func",
    },
	...
	-- 
    {
        ...
        Func    = "VairneGhost_Attack06_2Func",
    },
    ...
    -- 죽기 착지
    {
        ...
        Func    = "VairneGhost_DieLandingFunc",
...
CallBack =
{
    Land    = "OnVairneGhost_Land",
    Die     = "OnVairneGhost_Die",
    Damage  = "OnVairneGhost_Damage",
}
...
function InitVairneGhost( iMonsterIndex )
...
-- 대기 상태
function VairneGhost_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 걷기 상태
function VairneGhost_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
-- 걷기 상태
function VairneGhost_runFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
-- 죽기 착지
function VairneGhost_DieLandingFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 데미지 입은거
function VairneGhost_DamageFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  근접공격 상태
function VairneGhost_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
	if( iFrame <= 1 ) then
...
--  점프 상태
function VairneGhost_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  
function VairneGhost_Attack03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  
function VairneGhost_Attack04Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  
function VairneGhost_Attack05_1Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Attack05_2Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Attack06_Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Attack06_2Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function VairneGhost_JumpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 다운 상태
function VairneGhost_JumpDownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function VairneGhost_ToWait( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_ReleaseTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_Run( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function VairneGhost_CheckDownUp02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function VairneGhost_Check_Attack04( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function VairneGhost_Check_Attack05( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function VairneGhost_Check_Attack06( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function VairneGhost_Check_JumpUp( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
	...
	if( pMonster:CheckTargetInRange( 150, -150, 1200, 150, 80 ) == true and pMonster:GetIsContact() == true and pMonster:GetTargetIsContact() == true ) then
		VairneGhost_Jump( iMonsterIndex )
		pMonster:SetState( "JUMP" )
		pMonster:ResetDelay()
	end
end

function VairneGhost_Check_JumpDown( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnVairneGhost_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnVairneGhost_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnVairneGhost_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_Jump( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function VairneGhost_MoveFail( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
