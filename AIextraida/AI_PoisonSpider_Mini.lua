...
{	
    ...
    {
        ID      = "WALK",
        Motion  = "PoisonSpider_Move_Fast.frm",
    ...
    {
        ID      = "ATTACK02",
        Motion  = "PoisonSpider_JumpAttack.frm",
...
function InitPoisonSpider_Mini( iMonsterIndex )
...
function PoisonSpider_Attack01Func( iMonsterIndex, iFrame )
	...
	elseif( iFrame == 30 ) then
		pMonster:StartAttack( 3, PAR_BIG_DAMAGE, 0.0, 7, 13, 6)
    elseif( iFrame >= pMonster:GetLastFrame() ) then
        pMonster:SetState( "WAIT" )
    end
end
...
function PoisonSpider_Attack02Func( iMonsterIndex, iFrame )
	...
	if( iFrame == 1 ) then
		pMonster:PlaySound(999008)
	elseif( iFrame == 32 ) then
		pMonster:StartAttack( 3,PAR_DOWN, 0.05, 11, 11, 6)
	elseif( iFrame >= pMonster:GetLastFrame() ) then
        pMonster:SetState( "WAIT" )
    end
end
...
function PoisonSpider_Check_Targeting( iMonsterIndex, iFrame )
    ...
    if( pMonster:SetTarget( 100, -400, 200, 400, -100 ) == true or pMonster:SetTarget( 100, -200, 400, 200, -200 ) == true ) then
...
function PoisonSpider_Check_Attack01( iMonsterIndex, iFrame )
    ...
    if( pMonster:CheckTargetInRange( 80, -70, 20, 70, -80 ) == true ) then
...
function PoisonSpider_Check_Attack02( iMonsterIndex, iFrame )
    ...
    if( pMonster:CheckTargetInRange( 170, -100, 80, 100, -80 ) == true ) then
