...
{	
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 55,
                AIFunc              = "PowerLeader_Targeting",
                DelayFrame          = 200,
            },
            -- 타겟지움
            --{
            --    AICheckFrame        = 550,
            --    AIFunc              = "PowerLeader_Check_ReleaseTarget",
            --    DelayFrame          = 330,
            --},
            -- 타겟을 향해 턴
            {
                AICheckFrame        = 20,
                AIFunc              = "PowerLeader_Check_TurnToTarget",
                DelayFrame          = 20,
            },
            ...
            {
                AICheckFrame        = 91,
                AIFunc              = "PowerLeader_Check_JumpUp",
                DelayFrame          = 100,
            },
            ...
            {
                AICheckFrame        = 61,
                AIFunc              = "PowerLeader_Check_JumpDown",
                DelayFrame          = 80,
            },
            ...
            {
                AICheckFrame        = 10,
                AIFunc              = "PowerLeader_Check_Attack01",
                DelayFrame          = 90,
            },
            ...
            {
                AICheckFrame        = 110,
                AIFunc              = "PowerLeader_Check_Attack01_2",
                DelayFrame          = 330,
            },
            ...
            {
                AICheckFrame        = 220,
                AIFunc              = "PowerLeader_Check_Attack02",
                DelayFrame          = 220,
            },
            ...
            {
                AICheckFrame        = 55,
                AIFunc              = "PowerLeader_Check_Attack03",
                DelayFrame          = 550,
            },
            ...
            {
                AICheckFrame        = 200,
                AIFunc              = "PowerLeader_Check_Attack04",
                DelayFrame          = 400,
            },
            ...
            --{
            --    AICheckFrame        = 250,
            --    AIFunc              = "PowerLeader_Check_Attack06",
            --    DelayFrame          = 330,
            --},
        },
    },
    ...
    -- 이동
    {
        ...
        Func            = "PowerLeader_WalkFunc",
        EnableMoveCheck = TRUE,
        MoveFailFunc    = "PowerLeader_MoveFail",
    ...
    -- 데몬 파이어 A
    {
        ...
        Func    = "PowerLeader_Attack06_AFunc",
    },
    ...
    -- 데몬 파이어 B
    {
        ...
        Func    = "PowerLeader_Attack06_BFunc",
    },
    ...
    -- 죽기 착지
    {
        ...
        Func    = "PowerLeader_DieLandingFunc",
...
CallBack =
{
    Land    = "OnPowerLeader_Land",
    Die     = "OnPowerLeader_Die",
    Damage  = "OnPowerLeader_Damage",
}
...
function InitPowerLeader( iMonsterIndex )
...
-- 대기 상태
function PowerLeader_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 걷기 상태
function PowerLeader_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 죽기 착지
function PowerLeader_DieLandingFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  패러독스 스윙
function PowerLeader_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  3단 부스트 
function PowerLeader_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 윈드밀 대쉬 
function PowerLeader_Attack03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  스톰프
function PowerLeader_Attack04Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  더블 스톰프
function PowerLeader_Attack05Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  데몬 파이어 A
function PowerLeader_Attack06_AFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  데몬 파이어 B
function PowerLeader_Attack06_BFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
    local iDir = 1
...
--  점프 상태
function PowerLeader_JumpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 다운 상태
function PowerLeader_JumpDownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function PowerLeader_ToWait( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_Check_ReleaseTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_Check_Walk( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_Check_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function PowerLeader_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function PowerLeader_Check_Attack01_2( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function PowerLeader_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function PowerLeader_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function PowerLeader_Check_Attack04( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_Check_Attack06( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function PowerLeader_Check_JumpUp( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
	...
	if( pMonster:CheckTargetInRange( 220, -220, 1200, 220, 370 ) == true and pMonster:GetIsContact() == true and pMonster:GetTargetIsContact() == true ) then
		PowerLeader_Jump( iMonsterIndex )
...
function PowerLeader_Check_JumpDown( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnPowerLeader_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnPowerLeader_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnPowerLeader_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_Jump( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function PowerLeader_MoveFail( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
