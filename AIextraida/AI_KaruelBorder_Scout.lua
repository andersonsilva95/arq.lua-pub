...
{	
    -- 대기
    {
        ...
        Func    = "KaruelBorderScout_WaitFunc",
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 55,
                AIFunc              = "KaruelBorderScout_Check_Targeting",
                DelayFrame          = 110,
            },
            -- 타겟지움
            {
                AICheckFrame        = 100,
                AIFunc              = "KaruelBorderScout_Check_ReleaseTarget",
                DelayFrame          = 50,
            },
            -- 타겟을 향해 턴
            {
                AICheckFrame        = 20,
                AIFunc              = "KaruelBorderScout_Check_TurnToTarget",
                DelayFrame          = 15,
            },
            -- 걷기
            {
                AICheckFrame        = 50,
                AIFunc              = "KaruelBorderScout_Check_Walk",
                DelayFrame          = 110,
            },
            -- 점프업
            {
                AICheckFrame        = 20,
                AIFunc              = "KaruelBorderScout_Check_JumpUp",
                DelayFrame          = 30,
            },        
            -- 점프다운
            {
                AICheckFrame        = 35,
                AIFunc              = "KaruelBorderScout_Check_JumpDown",
                DelayFrame          = 20,
            },
            -- 어슬렁대기(이동)
            {
                AICheckFrame        = 55,
                AIFunc              = "KaruelBorderScout_Check_Idle",
                DelayFrame          = 150,
            },
			---- Attack01
            --{
            --    AICheckFrame        = 25,
            --    AIFunc              = "KaruelBorderScout_Check_Attack01",
            --    DelayFrame          = 55,
            --},
			-- Attack02
            {
                AICheckFrame        = 20,
                AIFunc              = "KaruelBorderScout_Check_Attack02",
                DelayFrame          = 90,
            },
			-- Attack03
            {
                AICheckFrame        = 20,
                AIFunc              = "KaruelBorderScout_Check_Attack03",
                DelayFrame          = 110,
            },
        }
    },
    ...
    -- 이동
    {
        ...
        Func            = "KaruelBorderScout_WalkFunc",
        EnableMoveCheck = TRUE,
        MoveFailFunc    = "KaruelBorderScout_MoveFail",
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 10,
                AIFunc              = "KaruelBorderScout_Check_Stop",
                DelayFrame          = 40,
            },
			-- 어슬렁대기(이동)
            {
    ...
    -- 어슬렁대기
    {
        ID              = "IDLE",
        Motion          = "Mon_Scout_f_Run.frm",
        Func            = "KaruelBorderScout_IdleFunc",
        EnableMoveCheck = TRUE,
        MoveFailFunc    = "KaruelBorderScout_IdleMoveFail",
        ...
        Trigger =
        {
			...
			{
                AICheckFrame        = 40,
                AIFunc              = "KaruelBorderScout_Check_Turnning",
                DelayFrame          = 110,
            },
            -- 어슬렁대기(멈춤)
            {
                AICheckFrame        = 30,
                AIFunc              = "KaruelBorderScout_Check_Idle_Stop",
                DelayFrame          = 55,
            },
        }
    },
    ...
    --    Func    = "KaruelBorderScout_Attack01Func",
    --},
    ...
    -- Attack02
    {
        ...
        Func    = "KaruelBorderScout_Attack02Func",
    },
    ...
    -- Attack03
    {
        ...
        Func    = "KaruelBorderScout_Attack03Func",
    },
    ...
    -- 점프 올라가는 중
    {
        ...
        Func    = "KaruelBorderScout_JumpFunc",
    },
    ...
    -- 점프 떨어지는 중
    {
        ...
        Func    = "KaruelBorderScout_JumpDownFunc",
    },
    ...
    -- 데미지 상
    {
        ...
        Func    = "KaruelBorderScout_DamageFunc",
    },
    ...
    -- 다운 상
    {
        ...
        Func    = "KaruelBorderScout_DownUpFunc",
        
        Trigger =
        {
            {
                AICheckFrame        = 1,
                AIFunc              = "KaruelBorderScout_CheckDownUp02",
                DelayFrame          = 0,
            },
        }
    },
    ...
    -- 다운 상02
    {
        ...
        Func    = "KaruelBorderScout_DownUp02Func",
	...
	-- 다운 상 착지
    {
        ...
        Func    = "KaruelBorderScout_DownFunc",
        IsFallDownMotion    = TRUE,
        ...
        Trigger =
        {
            {
                AICheckFrame        = 5,
                AIFunc              = "KaruelBorderScout_CheckStandup",
                DelayFrame          = 0,
            },
        }
    },
    ...
    -- 다운 하
    {
        ...
        Func    = "KaruelBorderScout_DownDownFunc",
        IsFallDownMotion    = TRUE,
    ...
    -- 다운 스페셜
    {
        ...
        Func    = "KaruelBorderScout_DownSpecialFunc",
        IsFallDownMotion    = TRUE,
    },
    ...
    -- 다운 스페셜 착지
    {
        ...
        Func    = "KaruelBorderScout_DownSpecialLandingFunc",
        IsFallDownMotion    = TRUE,
    ...
    -- 죽기
    {
        ID      = "DIE",
        Motion  = "Mon_Assassin_f_Down_Middle.frm",
        Func    = "KaruelBorderScout_DieFunc",
        IsFallDownMotion    = TRUE,
    },
    ...
    -- 일어나기
    {
        ...
        Func    = "KaruelBorderScout_StandupFunc",
    },
    ...
    -- 스톤커스
    {
        ...
        Func    = "KaruelBorderScout_StoneCurseFunc",
    },
    ...
    -- 빙결상태
    {
        ID      = "ICECURSE",
        Motion  = "Mon_Assassin_f_Stone.frm",
        Func    = "KaruelBorderScout_IceCurseFunc",
    },
    -- 홀드상태
	{
		ID		= "HOLD",
		Motion	= "Mon_Assassin_f_Stone.frm",
		Func	= "KaruelBorderScout_HoldFunc",
	},
}

CallBack =
{
    Land    = "OnKaruelBorderScout_Land",
    Die     = "OnKaruelBorderScout_Die",
    Damage  = "OnKaruelBorderScout_Damage",
}
...
function InitKaruelBorder_Scout( iMonsterIndex )
...
-- 대기 상태
function KaruelBorderScout_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 걷기 상태
function KaruelBorderScout_WalkFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 어슬렁대기 상태
function KaruelBorderScout_IdleFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- Attack01
function KaruelBorderScout_Attack01Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- Attack02
function KaruelBorderScout_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- Attack03
function KaruelBorderScout_Attack03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 상태
function KaruelBorderScout_JumpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프 다운 상태
function KaruelBorderScout_JumpDownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  점프에서 웨이트로
function KaruelBorderScout_ToWait( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 데미지 상, 중, 하
function KaruelBorderScout_DamageFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 상
function KaruelBorderScout_DownUpFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 상2
function KaruelBorderScout_DownUp02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 상 착지, 다운미들
function KaruelBorderScout_DownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 하
function KaruelBorderScout_DownDownFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 스페셜
function KaruelBorderScout_DownSpecialFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 다운 스페셜 착지
function KaruelBorderScout_DownSpecialLandingFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 죽기 착지
function KaruelBorderScout_DieFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 일어나기
function KaruelBorderScout_StandupFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  스톤커스 걸렸음
function KaruelBorderScout_StoneCurseFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  아이스커스 걸렸음
function KaruelBorderScout_IceCurseFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 홀드 걸렸음(이펙트)
function KaruelBorderScout_HoldFunc( iMonsterIndex, iFrame )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Check_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Check_ReleaseTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Check_TurnToTarget( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Check_Walk( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Check_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function KaruelBorderScout_CheckDownUp02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Check_Attack01( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function KaruelBorderScout_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function KaruelBorderScout_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function KaruelBorderScout_Check_JumpUp( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
	...
	if( pMonster:CheckTargetInRange( 0, -250, 560, 250, 70 ) == true and pMonster:GetIsContact() == true and pMonster:GetTargetIsContact() == true ) then
		KaruelBorderScout_Jump( iMonsterIndex )
		pMonster:SetState( "JUMP" )
		pMonster:ResetDelay()
	end
end

function KaruelBorderScout_Check_JumpDown( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function KaruelBorderScout_CheckStandup( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 어슬렁대기..  방향 바꾸기 후 이동
function KaruelBorderScout_Check_Idle( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Check_Turnning( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 어슬렁대는 중.. 멈추기
function KaruelBorderScout_Check_Idle_Stop( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 콜백 함수
-----------------------------------------------------------------------
function OnKaruelBorderScout_Land( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnKaruelBorderScout_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnKaruelBorderScout_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_Jump( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_MoveFail( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function KaruelBorderScout_IdleMoveFail( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
