...
ActionList =
{
    -- 대기
    {
        ...
        Trigger =
        {
            ...
            {
                AICheckFrame        = 25,
                AIFunc              = "Paradom_Check_Targeting",
                DelayFrame          = 110,
            },
            -- AT_Field
            {
                AICheckFrame        = 110,
                AIFunc              = "Paradom_Check_AtField",
                DelayFrame          = 330,
            },
            -- 레이저공격02
            {
                AICheckFrame        = 55,
                AIFunc              = "Paradom_Check_Attack02",
                DelayFrame          = 110,
            },
            -- 레이저공격03
            {
                AICheckFrame        = 75,
                AIFunc              = "Paradom_Check_Attack03",
                DelayFrame          = 330,
            },
            -- 레이저공격05,06
            {
                AICheckFrame        = 100,
                AIFunc              = "Paradom_Check_Attack05",
                DelayFrame          = 330,
            },
        },
    },
...
function InitParadom( iMonsterIndex )
...
-- 대기 상태
function Paradom_WaitFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
-- 죽는상태
function Paradom_DieFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  레이저공격02 상태
function Paradom_Attack02Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  레이저공격03 상태
function Paradom_Attack03Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  레이저공격05 상태
function Paradom_Attack05Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  레이저공격06 상태
function Paradom_Attack06Func( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
--  AT Field 상태
function Paradom_AtFieldFunc( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function Paradom_Check_Targeting( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function Paradom_Check_AtField( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Paradom_Check_Attack02( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Paradom_Check_Attack03( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function Paradom_Check_Attack05( iMonsterIndex, iFrame )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )    
...
function OnParadom_Die( iMonsterIndex )
	local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
...
function OnParadom_Damage( iMonsterIndex )
    local pMonster = g_MyD3D:GetMonster( iMonsterIndex )
